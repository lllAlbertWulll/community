	...
	<div class="container">
	  <div class="media">
		<div class="media-left">
		  <a href="">
			<img class="media-object img-circle" alt="64*64" src="{{ $discussion->user->avatar }}"
		...
		<div class="media-body">
		  <h4 class="media-heading">
			...
			@if(Auth::check() && Auth::user()->id == $discussion->user_id)
			  <a class="btn btn-sm btn-primary pull-right" href="/discussions/{{ $discussion->id }}/edit" role="button">修改帖子
				»</a>
			@endif
		  </h4>
